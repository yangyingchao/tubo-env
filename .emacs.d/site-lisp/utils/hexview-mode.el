...
(defgroup hexview nil
  "View a file in a hex format using the lazy reading."
  :group 'data)

(defconst hexview-line-width 16 "how many chars in a Hexview line")
;;how many lines in a Hexview buffer
;(defconst hexview-line-height 32)
(defcustom hexview-line-height 32
  "how many lines in a Hexview buffer"
  :type 'integer
  :group 'hexview)
...
(defun hexview-find-file (f)
  ...
  (interactive "f")
  (if (> (or (nth 7 (file-attributes f)) 0) 104857600)
